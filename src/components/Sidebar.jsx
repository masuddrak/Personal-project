...
import profilePic from '../../public/resume/masud.PNG'
      ...
      <div className="">
        <div>
          ...
          <div className="flex flex-col justify-center items-center p-5">
            <h1 className="text-[25px] font-semibold">MD.Masud Rana</h1>
            <h2 className="text-[#909090] text-[18px] font-semibold">
              masudranaacb@gmail.com
            </h2>
          </div>
          <div>
          ...
          <div>
            <div className="bg-gradient-to-r from-[rgba(18,25,27,1)] to-[rgba(12,56,42,1)] flex justify-center gap-5">
              ...
              <a href="https://www.linkedin.com/in/masudranamasud/" target="blank" className="text-[25px] py-5">
                <FontAwesomeIcon icon={faLinkedin} />
              </a>
              <a href="https://github.com/masuddrak" target="blank" className="text-[25px] py-5">
